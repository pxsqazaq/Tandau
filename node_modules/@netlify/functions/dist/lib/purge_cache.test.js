    ...
    var SemVer = class _SemVer {
      ...
      comparePre(other) {
        ...
        do {
          ...
          debug("prerelease compare", i, a3, b);
...
var require_sort = __commonJS({
  "node_modules/semver/functions/sort.js"(exports2, module2) {
    ...
    var sort2 = (list, loose) => list.sort((a3, b) => compareBuild(a3, b, loose));
...
var require_eq = __commonJS({
  "node_modules/semver/functions/eq.js"(exports2, module2) {
    "use strict";
    var compare = require_compare();
    var eq2 = (a3, b, loose) => compare(a3, b, loose) === 0;
    module2.exports = eq2;
  }
});
...
var require_gte = __commonJS({
  "node_modules/semver/functions/gte.js"(exports2, module2) {
    "use strict";
    var compare = require_compare();
    var gte = (a3, b, loose) => compare(a3, b, loose) >= 0;
    module2.exports = gte;
  }
});
...
var require_lte = __commonJS({
  "node_modules/semver/functions/lte.js"(exports2, module2) {
    "use strict";
    var compare = require_compare();
    var lte = (a3, b, loose) => compare(a3, b, loose) <= 0;
    module2.exports = lte;
  }
});
...
var require_range = __commonJS({
  "node_modules/semver/classes/range.js"(exports2, module2) {
    ...
    var replaceTilde = (comp, options) => {
      ...
      return comp.replace(r2, (_, M, m3, p4, pr) => {
        debug("tilde", comp, _, M, m3, p4, pr);
        let ret;
        if (isX(M)) {
          ret = "";
        } else if (isX(m3)) {
    ...
    var replaceCaret = (comp, options) => {
      ...
      return comp.replace(r2, (_, M, m3, p4, pr) => {
        ...
        if (isX(M)) {
          ...
          if (M === "0") {
            if (m3 === "0") {
              ret = `>=${M}.${m3}.${p4}${z} <${M}.${m3}.${+p4 + 1}-0`;
            } else {
              ret = `>=${M}.${m3}.${p4}${z} <${M}.${+m3 + 1}.0-0`;
            }
          } else {
    ...
    var replaceXRange = (comp, options) => {
      ...
      return comp.replace(r2, (ret, gtlt, M, m3, p4, pr) => {
        debug("xRange", comp, ret, gtlt, M, m3, p4, pr);
        const xM = isX(M);
        const xm = xM || isX(m3);
        const xp = xm || isX(p4);
        const anyX = xp;
...
var require_simplify = __commonJS({
  "node_modules/semver/ranges/simplify.js"(exports2, module2) {
    ...
    module2.exports = (versions, range, options) => {
      ...
      let first = null;
      let prev = null;
      const v = versions.sort((a3, b) => compare(a3, b, options));
...
var require_dist = __commonJS({
  "node_modules/expect-type/dist/index.js"(exports2) {
    ...
    var __exportStar = exports2 && exports2.__exportStar || function(m3, exports3) {
      for (var p4 in m3) if (p4 !== "default" && !Object.prototype.hasOwnProperty.call(exports3, p4)) __createBinding(exports3, m3, p4);
    };
    Object.defineProperty(exports2, "__esModule", { value: true });
...
function requireReactIs_production_min() {
  ...
  reactIs_production_min.isValidElementType = function(a3) {
    return "string" === typeof a3 || "function" === typeof a3 || a3 === d2 || a3 === f4 || a3 === e || a3 === m3 || a3 === n2 || a3 === t || "object" === typeof a3 && null !== a3 && (a3.$$typeof === q || a3.$$typeof === p4 || a3.$$typeof === g || a3.$$typeof === h3 || a3.$$typeof === l2 || a3.$$typeof === u2 || void 0 !== a3.getModuleId) ? true : false;
  };
...
var K = (e) => (f2(e, u, { value: { reset: () => P(e[u]) } }), e[u]);
var T = (e) => e[u] || K(e);
function m2(e) {
  d(
...
var EXPECTED_COLOR = p2.green;
var RECEIVED_COLOR = p2.red;
var INVERTED_COLOR = p2.inverse;
var BOLD_WEIGHT = p2.bold;
var DIM_COLOR = p2.dim;
...
var Subset = /* @__PURE__ */ getDefaultExportFromCjs2(chaiSubsetExports);
...
${job.error.stack.split("\n").slice(matchedLineIndex + 1).join("\n")}`;
    ...
    function mirrorDateProperties(target, source) {
      ...
      target.toString = function toString5() {
...
var invokeLambda = (handler, { method = "GET", ...options } = {}) => {
  const event = {
    ...options,
    httpMethod: method
  };
  return new Promise((resolve4, reject) => {
    ...
    resolve4(handler(event, {}, callback));
  });
};

// test/helpers/mock_fetch.mjs
  ...
  get fetcher() {
    return async (...args) => {
      ...
      const match = this.requests.find(
        (request) => request.method.toLowerCase() === options?.method.toLowerCase() && request.url === urlString && !request.fulfilled
      );
      if (!match) {
        throw new Error(`Unexpected fetch call: ${url}`);
      }
      for (const key in match.headers) {
        import_node_assert.default.equal(headers[key], match.headers[key]);
      }
...
var hasFetchAPI = import_semver.default.gte(import_node_process.default.version, "18.0.0");
beforeEach(() => {
  delete import_node_process.default.env.NETLIFY_PURGE_API_TOKEN;
  delete import_node_process.default.env.SITE_ID;
  delete import_node_process.default.env.NETLIFY_LOCAL;
});
afterEach(() => {
  globalThis.fetch = globalFetch;
});
test3("Calls the purge API endpoint and returns `undefined` if the operation was successful", async () => {
  if (!hasFetchAPI) {
  ...
  import_node_process.default.env.NETLIFY_PURGE_API_TOKEN = mockToken;
  import_node_process.default.env.SITE_ID = mockSiteID;
  const mockAPI = new MockFetch().post({
    body: (payload) => {
      const data = JSON.parse(payload);
      globalExpect(data.site_id).toBe(mockSiteID);
    },
  ...
  globalExpect(response).toBeUndefined();
  globalExpect(mockAPI.fulfilled).toBeTruthy();
});
test3("Does not default the deploy_alias field to process.env.NETLIFY_BRANCH if supplied in the options", async () => {
  const mockSiteID = "123456789";
  const mockToken = "1q2w3e4r5t6y7u8i9o0p";
  import_node_process.default.env.NETLIFY_PURGE_API_TOKEN = mockToken;
  import_node_process.default.env.SITE_ID = mockSiteID;
  import_node_process.default.env.NETLIFY_BRANCH = "main";
  const mockAPI = new MockFetch().post({
    body: (payload) => {
      const data = JSON.parse(payload);
      globalExpect(data.site_id).toBe(mockSiteID);
      globalExpect(data.deploy_alias).toBe("test");
    },
    headers: { Authorization: `Bearer ${mockToken}` },
    method: "post",
    response: new Response(null, { status: 202 }),
...
test3("Defaults the deploy_alias field to process.env.NETLIFY_BRANCH if not running locally", async () => {
  const mockSiteID = "123456789";
  const mockToken = "1q2w3e4r5t6y7u8i9o0p";
  import_node_process.default.env.NETLIFY_PURGE_API_TOKEN = mockToken;
  import_node_process.default.env.SITE_ID = mockSiteID;
  ...
  const mockAPI = new MockFetch().post({
    body: (payload) => {
      const data = JSON.parse(payload);
      globalExpect(data.site_id).toBe(mockSiteID);
      globalExpect(data.deploy_alias).toBe(import_node_process.default.env.NETLIFY_BRANCH);
    },
    headers: { Authorization: `Bearer ${mockToken}` },
    method: "post",
    response: new Response(null, { status: 202 }),
...
test3("Does not default the deploy_alias field to process.env.NETLIFY_BRANCH when running locally", async () => {
  const mockSiteID = "123456789";
  const mockToken = "1q2w3e4r5t6y7u8i9o0p";
  import_node_process.default.env.NETLIFY_PURGE_API_TOKEN = mockToken;
  import_node_process.default.env.SITE_ID = mockSiteID;
  import_node_process.default.env.NETLIFY_LOCAL = "true";
  import_node_process.default.env.NETLIFY_BRANCH = "main";
  const mockAPI = new MockFetch().post({
    body: (payload) => {
      const data = JSON.parse(payload);
      globalExpect(data.site_id).toBe(mockSiteID);
      globalExpect(data.deploy_alias).toBeUndefined();
    },
    headers: { Authorization: `Bearer ${mockToken}` },
    method: "post",
    response: new Response(null, { status: 202 }),
...
test3("Throws an error if the API response does not have a successful status code, using the response body as part of the error message", async () => {
  if (!hasFetchAPI) {
    console.warn("Skipping test requires the fetch API");
    return;
  }
  ...
  try {
    ...
    globalExpect.fail("Invocation should have failed");
  } catch (error) {
    globalExpect(error.message).toBe(
      "Cache purge API call was unsuccessful.\nStatus: 404\nBody: site not found"
    );
  }
});
test3("Throws if the API response does not have a successful status code, does not include the response body if it is not text", async () => {
  if (!hasFetchAPI) {
    console.warn("Skipping test requires the fetch API");
    return;
  }
  ...
  try {
    ...
    globalExpect(error.message).toBe("Cache purge API call was unsuccessful.\nStatus: 500");
  }
});
test3("Ignores purgeCache if in local dev with no token or site", async () => {
  if (!hasFetchAPI) {
    console.warn("Skipping test requires the fetch API");
    return;
  }
  import_node_process.default.env.NETLIFY_LOCAL = "1";
  const mockAPI = new MockFetch().post({
    body: () => {
...
test3("Accepts a custom user-agent", async () => {
  if (!hasFetchAPI) {
    console.warn("Skipping test requires the fetch API");
    return;
  }
