...
function isMatchingTargetPath(filename, targetPath) {
    if ((0, is_glob_1.default)(targetPath)) {
        const mm = new minimatch_1.Minimatch(targetPath, { windowsPathsNoEscape: true });
...
module.exports = (0, utils_1.createRule)({
    ...
    create(context) {
        ...
        function computeGlobPatternPathValidator(absoluteFrom, zoneExcept) {
            let isPathException;
            const mm = new minimatch_1.Minimatch(absoluteFrom, { windowsPathsNoEscape: true });
            ...
            if (hasValidExceptions) {
                const exceptionsMm = zoneExcept.map(except => new minimatch_1.Minimatch(except, { windowsPathsNoEscape: true }));
