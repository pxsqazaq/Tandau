import{f as E,q as x}from"./kvwmbylm.js";import{_ as N}from"./stacktrace-list.vue-gmd7fzml.js";import{q as y,u as v,O as l,a0 as i,a2 as C,P as f,Q as _,a1 as w,a8 as S,a7 as p,R as O}from"./vendor/json-editor-vue-huf8dypo.js";import"./vendor/unocss-e7oqigho.js";import"./vendor/shiki-jv02kgzv.js";import"./filepath-item.vue-fd1zdt53.js";const R=/(^|@)\S+:\d+/,h=/^\s*at .*(\S+:\d+|\(native\))/m,$=/^(eval@)?(\[native code\])?$/;function F(e,a){if(typeof e.stacktrace<"u"||typeof e["opera#sourceloc"]<"u")return T(e);if(e.stack&&e.stack.match(h))return I(e);if(e.stack)return A(e);throw new Error("Cannot parse given Error object")}function m(e){if(!e.includes(":"))return[e,void 0,void 0];const o=/(.+?)(?::(\d+))?(?::(\d+))?$/.exec(e.replace(/[()]/g,""));return[o[1],o[2]||void 0,o[3]||void 0]}function d(e,a){return e}function I(e,a){return b(e.stack)}function b(e,a){return d(e.split(`
