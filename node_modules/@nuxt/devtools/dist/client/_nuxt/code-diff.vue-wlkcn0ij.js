...
`)&&(e=e.slice(0,-1))),g.prototype.equals.call(this,n,e,r)};function ne(n,e,r){return $.diff(n,e,r)}var re=new g;re.tokenize=function(n){return n.split(/(\S.+?[.!?])(?=\s+|$)/)};var oe=new g;oe.tokenize=function(n){return n.split(/([{}:;,]|\s+)/)};function N(n){"@babel/helpers - typeof";return N=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},N(n)}var D=new g;D.useLongestToken=!0;D.tokenize=$.tokenize;D.castInput=function(n,e){var r=e.undefinedReplacement,t=e.stringifyReplacer,u=t===void 0?function(o,i){return typeof i>"u"?r:i}:t;return typeof n=="string"?n:JSON.stringify(A(n,null,null,u),u,"  ")};D.equals=function(n,e,r){return g.prototype.equals.call(D,n.replace(/,([\r\n])/g,"$1"),e.replace(/,([\r\n])/g,"$1"),r)};function A(n,e,r,t,u){e=e||[],r=r||[],t&&(n=t(u,n));var o;for(o=0;o<e.length;o+=1)if(e[o]===n)return r[o];var i;if(Object.prototype.toString.call(n)==="[object Array]"){for(e.push(n),i=new Array(n.length),r.push(i),o=0;o<n.length;o+=1)i[o]=A(n[o],e,r,t,u);return e.pop(),r.pop(),i}if(n&&n.toJSON&&(n=n.toJSON()),N(n)==="object"&&n!==null){e.push(n),i={},r.push(i);var f=[],l;for(l in n)Object.prototype.hasOwnProperty.call(n,l)&&f.push(l);for(f.sort(),o=0;o<f.length;o+=1)l=f[o],i[l]=A(n[l],e,r,t,l);e.pop(),r.pop()}else i=n;return i}var J=new g;J.tokenize=function(n){return n.slice()};J.join=J.removeEmpty=function(n){return n};const le=U({__name:"CodeDiff",props:{from:{},to:{},lang:{}},setup(n){const e=n;function r(f,l){const s=ne(f.trim(),l.trim()),a=[],c=[],p=[];for(const d of s){const m=d.value.trimEnd().split(`
